[Setup]
AppName=Tarkov Desktop
AppVersion=1.0.0
DefaultDirName={pf}\Tarkov Desktop
DefaultGroupName=Tarkov Desktop
...
Source: "build\windows\x64\runner\Release\backend.exe"; DestDir: "{app}"; Flags: ignoreversion
...
[Icons]
Name: "{group}\Tarkov Desktop"; Filename: "{app}\tarkov_desktop.exe"
Name: "{commondesktop}\Tarkov Desktop"; Filename: "{app}\tarkov_desktop.exe"; Tasks: desktopicon
